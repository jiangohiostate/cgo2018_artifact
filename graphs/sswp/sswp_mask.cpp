...
int main(int argc, char *argv[])
{
  ...
  while(wake_size != 0) {
    ...
    __m512i vbound = _mm512_set1_epi32(t);
      ...
      vdx = _mm512_mask_i32gather_ps(vdx, mload, vnx, width, 4);
      vdy = _mm512_mask_i32gather_ps(vdy, mload, vny, width, 4);

      vnewdy = _mm512_min_ps(vdx, vw);
      ...
      mload = _mm512_mask_cmpeq_epi32_mask(mbound, vconf, vzero);
		  ...
		  _mm512_mask_i32scatter_ps(width_new, mload, vny, vnewdy, 4);
